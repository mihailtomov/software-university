...
Адресът на базата данни е mongodb://localhost:27017/ExpenseTracker (чест проблем да не тръгне е ако в services не е стартиран mongoDB сървъра)
Името на базата данни е: ExpenseTracker

Добавен е css за fadeout анимация на съобщенията при грешка, тоест след 3 секунди съобщенията изчезват

При възникване на вътрешни грешки, извън тези, които се очакват, глобалният error handler връща status code 500 Internal Server Error на клиента
и отпечатва грешката на конзолата
